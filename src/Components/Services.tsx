        ...
        <>
            ...
            <div>
                ...
                <div className="py-16 px-6 md:px-20">
                    <h2 className="text-3xl bg-blue-100 font-semibold text-center text-blue-900 mb-12">
                        What We Do
                    </h2>

                    <div className="bg-white shadow-lg text-center rounded-xl p-6 border-t-4 border-blue-900 mb-6 ">
